...
GS.inherit = function(classObj, members) {
    ...
    function() {
        ...
        draw: function() {
            if (this.menuActive) $('.interface').show();
        ...
        attachReboundEventHandlers: function() {
            ...
            var keyButtonMap = {
                ...
                // automap: this.btnToggleAutomap,
                // esc: this.btnToggleMenu,
        ...
        this.cvs = vectorCanvas, this.assets = assets, this.player = player, this.fontSize = 40, this.boxCornerRadius = 10, this.useText = "[" + GS.Keybinds.use.controlName + "] to use", this.pointerLockText = "tap to start", this.restartText = "[TAP] somewhere to restart", this.usePopup = {
        ...
        update: function() {
            this.showUsePopup = this.player.canUse,
             this.showUsePopup != this.oldShowUsePopup && (this.needsRedraw = !0, this.oldShowUsePopup = this.showUsePopup),
              this.showPointerLockPopup = !this.player.controls.pointerLockEnabled,
               this.showPointerLockPopup != this.oldShowPointerLockPopup && (this.needsRedraw = !0, this.oldShowPointerLockPopup = this.showPointerLockPopup),
                this.showRestartPopup = this.player.dead, this.showRestartPopup != this.oldShowRestartPopup && (this.needsRedraw = !0, this.oldShowRestartPopup = this.showRestartPopup)
        },
        draw: function() {
        ...
        vertexShader: ["", "void main() {", "", "", "}"].join("\n"),
        fragmentShader: ["", "", "void main() {", "", "", "", "", "}"].join("\n")
    }, GS.ColorShader = {
        uniforms: {
            tDiffuse: {
                type: "t",
    ...
    GS.ZipAssetLoader.prototype = {
        ...
        init: function() {
            for (var j in GS.AssetTypes) {
                ...
                for (var i in assetDict) this.add(i,
                  assetDict[i].filename,
                  GS.AssetTypes[j])
            }
        },
        ...
        collideMonster: function(monster, oldPos, newPos) {
          if (30 > Math.abs(monster.position.x - GAME.grid.player.position.x) || 30 > Math.abs(monster.position.z - GAME.grid.player.position.z)) {
            GS.Keybinds.shoot.inUse = true
            setTimeout(function () {
              GS.Keybinds.shoot.inUse = false;
            }, 1);
          }
        ...
        attachEvents: function() {
            ...
            // $('.start2').on('touchstart', function () {
            //   rightMouseDown = !0;
            //   GAME.grid.player.controls.enable()
            // });
            $(this.debugCanvas).on("mousedown.fpsControls", function(e) {
                ...
                3 == e.which && rightMouseDown && (rightMouseDown = !1, console.log(that), that.enable())
            })
        },
        ...
        onResize: function() {
            ...
            this._halfSizeEnabled && (width *= procent_resolution/100, height *= procent_resolution/100);
    ...
    }, THREE.EventDispatcher.prototype.apply(GS.PlayerView.prototype), GS.GameVersion = "v1.0.0", GS.ReleaseDate = "09.10.2018", GS.GameStates = {
        Dispose: 0,
        PreLoad: 1,
        Loading: 2,
        PostLoad: 3,
        ...
        openMenu: function() {
            ...
            void 0 !== this.grid && (this.grid.player.inMenu = !0, this.grid.player.controls.disable(), this.grid.player.controls.detachEvents()),

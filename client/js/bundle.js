...
var logo = (function(){
	...
	dt(c.ctx,'black',' polyomino',P.maskSize * 3,P.maskSize * 3,0,0,'left');
	dt(c.ctx,'red',' polyomino',P.maskSize * 2,P.maskSize * 2,0,0,'left');
	dt(c.ctx,'purple',' polyomino',P.maskSize,P.maskSize,0,0,'left');
	dt(c.ctx,'white',' polyomino',0,0,0,0,'left');
